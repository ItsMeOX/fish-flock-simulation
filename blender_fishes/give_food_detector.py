...
#t = tf.lite.Interpreter(model_path = "C:\\Users\\ongxu\\Downloads\\DTI Blender\\model\\keypoint_classifier\\keypoint_classifier.tflite", num_threads = 1)

#root = [s for s in sys.path]
#sys.path += [r"C:\Users\ongxu\Downloads\DTI Blender"]
#print(len(sys.path))
...
def main():
    ...
    # Camera preparation ###############################################################
    cap = cv.VideoCapture(1) # Change to 1 for Xbox
    ...
    cv.resizeWindow("Hand Gesture Recognition", 1400, 700)
...
#                     cube.location.x = brect[0]
#                     cube.location.y = brect[1]
